...
$pagina_admin = 2;
$video = 0;
$nombre_pagina = "Condiciones de uso";
...
<div class="politicas">
    <div class="container">
        <div class="row shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <p>Los precios de los productos ofrecidos en esta Pagina Online es válido solamente en las compras realizadas en este sitio web.</p>
            <span>LICENCIA</span>

            <p>Innovative Transport  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>

            <span>USO NO AUTORIZADO</span>
            ...
            <span>COMPROBACIÓN ANTIFRAUDE</span>
            ...
            <p>Innovative Transport reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
        </div>
    </div>
</div>
